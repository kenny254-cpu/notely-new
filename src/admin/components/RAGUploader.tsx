...
export default function RAGUploader() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-extrabold mb-2 text-gray-900 dark:text-white">RAG Knowledge Base Management</h1>
      ...
      <Tabs defaultValue="upload" className="w-full">
        <TabsList className="grid w-full grid-cols-2 lg:w-96 mb-6 bg-gray-100 dark:bg-gray-800">
          <TabsTrigger
            value="upload"
            className="flex items-center gap-2 data-[state=active]:bg-fuchsia-600 data-[state=active]:text-white"
          >
              ...
              <TableBody>
                {docs.map((d) => (
                  <TableRow key={d.id} className="dark:hover:bg-gray-800/50">
                    ...
                    <TableCell className="text-sm text-gray-600 dark:text-gray-400">{d.source || "Manual"}</TableCell>
