      ...
      <Card className="max-w-3xl mx-auto">
        ...
        <CardContent className="space-y-6">
          ...
          >
            ...
            <p className="text-sm text-muted-foreground mt-1">Accepted: {ACCEPTED_FILE_TYPES} (Max 10MB)</p>
            {/* Hidden native input */}
            <Input
              id={fileInputId}
              type="file"
          ...
          <div className="flex justify-between items-center pt-2">
            ...
            {!file && <span className="text-sm text-muted-foreground">Select a document to begin.</span>}
