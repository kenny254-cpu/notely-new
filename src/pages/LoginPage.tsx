...
async function loginWithProvider(provider: "google" | "github") {
  ...
  if (error) toast.error("Social login failed", { description: error.message })
}
...
const SocialLoginButtons = () => (
  <div className="flex flex-col gap-3">
    <Button
      ...
      className="w-full flex justify-center items-center gap-3 bg-red-600 hover:bg-red-700 text-white"
    >
    ...
    <Button
      ...
      className="w-full flex justify-center items-center gap-3 bg-gray-700 hover:bg-gray-600 text-white"
    >
...
export function LoginPage() {
  ...
  const handleResendVerification = async () => {
    ...
    try {
      ...
      toast.success("Verification email sent", { description: "Check your inbox and confirm your email." })
    } finally {
      setResending(false)
    }
  }
