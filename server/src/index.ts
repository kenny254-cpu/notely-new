import express, { type Request, type Response, type NextFunction } from "express" // Added NextFunction for middleware typing
...
import contactRouter from "./routes/contact.ts" // Added contact router
