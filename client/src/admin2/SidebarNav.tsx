...
export function AdminSidebar() {
  return (
    <Sidebar collapsible="icon" className="dark:bg-gray-900 border-r dark:border-gray-800">
      {/* --- Header (Sticky Top) --- */}
      <SidebarHeader className="flex items-center justify-between p-4 h-16">
        <div className="flex items-center space-x-2">
          <Home className="h-6 w-6 text-fuchsia-400" />
          <h1 className="text-xl font-bold tracking-tight text-white">Notely Admin</h1>
        </div>
