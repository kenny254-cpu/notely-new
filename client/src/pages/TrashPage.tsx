...
interface Entry {
  ...
  category: {
    // Category included via API include
    name: string
  }
}
// ------------------------------------
  ...
  if (!entries.length)
    return (
      <div className="mt-16 flex flex-col items-center justify-center text-center space-y-6 p-8 border-2 border-dashed border-fuchsia-300 dark:border-fuchsia-800 rounded-xl bg-gray-50 dark:bg-gray-900/50">
        ...
        <p className={`text-sm ${PRIMARY_COLOR_CLASS}`}>Items are permanently removed after 30 days.</p>
      </div>
    )
  ...
  return (
    <div className="space-y-8 p-4 sm:p-6 lg:p-8">
      <div className="flex justify-between items-center pb-4 border-b dark:border-gray-700">
        ...
        >
          {emptyTrashMutation.isPending ? <Loader2 className="h-5 w-5 animate-spin" /> : <Zap className="h-5 w-5" />}
          Empty Trash Now
        </Button>
      </div>
            ...
            >
              ...
              <CardHeader className="pb-2">
                ...
                <CardDescription className="flex items-center gap-2 text-xs text-gray-600 dark:text-gray-400 mt-1">
                  <span
                    className={`inline-flex items-center font-medium p-1 rounded-sm bg-fuchsia-50 dark:bg-fuchsia-900/30 ${PRIMARY_COLOR_CLASS}`}
                  >
              ...
              <CardContent className="pt-0 pb-4 flex-1">
                <p className="text-sm text-muted-foreground line-clamp-3 mb-4">
                  {entry.synopsis || "No synopsis available."}
                </p>
      ...
      <div className="p-4 bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 rounded-lg text-sm text-red-700 dark:text-red-400 flex items-center gap-2 mt-8">
        ...
        <span className="font-medium">
          **Warning:** Permanently deleting an item removes it forever and **cannot be undone**. Items are automatically
